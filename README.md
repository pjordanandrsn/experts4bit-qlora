...
**Current position, one page:** [`docs/STATUS.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/STATUS.md).
**Every number, with its evidence and status:** [`docs/claims.json`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/claims.json).
...
Reasoning and caveats for each: [`docs/CHOOSING.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/CHOOSING.md).
...
- **A parity delta is read against a per-model noise floor, never
  ...
  [`docs/METHODOLOGY.md` §13.1](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/METHODOLOGY.md).
...
[`docs/STATUS.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/STATUS.md#what-changed--retired-superseded-corrected)
...
evidence: [`docs/ARCHITECTURE_SUPPORT.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/ARCHITECTURE_SUPPORT.md).
...
| | |
|---|---|
| [`docs/STATUS.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/STATUS.md) | what you get, what was retired, what is open — one page |
| [`docs/claims.json`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/claims.json) | every claim with value, hardware, status, evidence |
| [`docs/INDEX.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/INDEX.md) | what each of the 42 documents is, and whether it is current |
...
| [`docs/DEEPSEEK-V4.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/DEEPSEEK-V4.md) | V4's storage split, epilogue, arena bake |
| [`docs/BITSANDBYTES.md`](https://github.com/pjordanandrsn/experts4bit-qlora/blob/v0.32.0/docs/BITSANDBYTES.md) | relationship to bitsandbytes, prior art |
