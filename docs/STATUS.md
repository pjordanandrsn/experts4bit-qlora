...
- **[#392](https://github.com/pjordanandrsn/experts4bit-qlora/issues/392) —
  ...
  `docs/METHODOLOGY.md` §10 names "0.50.0.dev0 / the fork (bnb 0.50-dev)"
  and no commit; the harness prints the GPU name, not
  `bitsandbytes.__version__`. Until it is rerun on a recorded release,
