#!/bin/bash
# P66 rehearsal, round 6: P66_MODE=full with the final staged tree (captured windows counted from the graph's own
# node list). NOT a reading.
set -u
...
env $COMMON P66_RUN_ID=p66-rehearsal-a2000-r6 P66_RUN_NONCE=$NONCE P66_DEADLINE_EPOCH=$(( $(date +%s) + 5400 )) \
