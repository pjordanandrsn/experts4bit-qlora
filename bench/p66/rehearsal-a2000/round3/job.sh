#!/bin/bash
# P66 rehearsal, round 3: bench/p66/p66_run.sh ITSELF, end to end on the A2000, with its documented rehearsal
# overrides (local snapshots, the prebaked OLMoE arena, no install, A2000 minimums). NOT a reading.
set -u
