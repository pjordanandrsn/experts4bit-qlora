...
# (b) P66_MODE=full with the committed tree. NOT a reading.
set -u
...
# keep the receipts: the container's /root/p66 goes with it
rm -rf /w/work/r8full; mkdir -p /w/work/r8full; cp -R $R/* /w/work/r8full/; rm -rf /w/work/r8full/src
echo "receipts kept in /w/work/r8full"
