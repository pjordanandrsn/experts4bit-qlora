...
| nf4 | hf.proj | verify17 | 0/68 | {'L0.attn_core': 68} | 8.73e-04 | 1 | not exact; first diff at L0 in ['attn_core'] | HELD |
| nf4 | hf.proj | verify16 | 0/64 | {'L0.attn_core': 64} | 8.17e-04 | 1 | not exact; first diff at L0 in ['attn_core'] | HELD |
| nf4 | hf.proj | prefill | 0/160 | {'L0.attn_core': 126, 'L9.attn_core': 29, 'L8.mlp_out': 2, 'L1.attn_core': 2, 'logits': 1} | 8.56e-04 | 1 | None | INFO |
| nf4 | hf.core | verify17 | 0/68 | {'L0.attn_core': 55, 'L0.attn_out': 12, 'L0.mlp_out': 1} | 1.10e-03 | 1 | not exact; first diff at L0 in ['attn_core'] | REFUTED |
| nf4 | hf.core | verify16 | 0/64 | {'L0.attn_core': 64} | 7.66e-04 | 1 | not exact; first diff at L0 in ['attn_core'] | HELD |
...
| nf4 | paged.proj | verify17 | 0/68 | {'L0.attn_core': 68} | 1.44e-03 | 1 | no first diff at L0 in ['attn_core', 'attn_in', 'attn_out'] | REFUTED |
| nf4 | paged.proj | verify16 | 0/64 | {'L0.attn_core': 64} | 1.69e-03 | 0 | no first diff at L0 in ['attn_core', 'attn_in', 'attn_out'] | REFUTED |
...
| int4 | hf.proj | verify17 | 0/68 | {'L0.attn_core': 68} | 1.84e-03 | 0 | not exact; first diff at L0 in ['attn_core'] | HELD |
| int4 | hf.proj | verify16 | 0/64 | {'L0.attn_core': 64} | 1.82e-03 | 0 | not exact; first diff at L0 in ['attn_core'] | HELD |
| int4 | hf.proj | prefill | 0/160 | {'L0.attn_in': 160} | 2.14e-03 | 4 | None | INFO |
| int4 | hf.core | verify17 | 0/68 | {'L0.attn_core': 68} | 2.10e-03 | 0 | not exact; first diff at L0 in ['attn_core'] | HELD |
| int4 | hf.core | verify16 | 0/64 | {'L0.attn_core': 64} | 1.88e-03 | 0 | not exact; first diff at L0 in ['attn_core'] | HELD |
...
| int4 | paged.proj | verify17 | 0/68 | {'L0.attn_core': 68} | 1.78e-03 | 0 | no first diff at L0 in ['attn_core', 'attn_in', 'attn_out'] | REFUTED |
| int4 | paged.proj | verify16 | 0/64 | {'L0.attn_core': 64} | 2.42e-03 | 0 | no first diff at L0 in ['attn_core', 'attn_in', 'attn_out'] | REFUTED |
| int4 | paged.proj | prefill | 0/160 | {'L0.attn_in': 160} | 4.34e-03 | 4 | not exact; first diff at L0 in ['attn_core'] | REFUTED |
...
## Verdicts
- ablation predictions held: 25; refuted: ['nf4 hf.core verify17', 'nf4 paged.proj verify17', 'nf4 paged.proj verify16', 'int4 hf.all prefill', 'int4 paged.proj verify17', 'int4 paged.proj verify16', 'int4 paged.proj prefill']
