...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.gpt_oss.modeling_gpt_oss import (F, Callable, Optional, torch, nn, init, ROPE_INIT_FUNCTIONS, dynamic_rope_update, maybe_autocast, GptOssConfig, GptOssMLP, GptOssExperts)
...
class GptOssRMSNorm(nn.Module):
    ...
    def forward(self, hidden_states) -> torch.Tensor:
        return GptOssRMSNorm_forward(self, hidden_states=hidden_states)
...
def GptOssTopKRouter_forward(self, hidden_states):
    ...
    router_scores = torch.nn.functional.softmax(router_top_value, dim=1, dtype = torch.float32).to(router_top_value.dtype)
...
class GptOssTopKRouter(nn.Module):
    ...
    def forward(self, hidden_states):
        return GptOssTopKRouter_forward(self, hidden_states=hidden_states)
...
class GptOssMLP(nn.Module):
    ...
    def forward(self, hidden_states):
        return GptOssMLP_forward(self, hidden_states=hidden_states)
...
class GptOssRotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        return GptOssRotaryEmbedding_forward(self, x=x, position_ids=position_ids)
