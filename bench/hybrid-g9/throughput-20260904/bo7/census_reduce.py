...
after TP_DONE on the same box and install; its rows print `pending` until its receipts land (they did: TP2_DONE 08:52:27Z), then the licensed-best
row carries the three axes (the anchor projection included) for real. What each arm ENGAGED is read from its run log
